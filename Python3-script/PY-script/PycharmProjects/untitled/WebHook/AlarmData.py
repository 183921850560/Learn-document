...
class AlarmData(unittest.TestCase):
    ...
    def test_AlarmData(self):
        ...
        #传入请求的参数
        self.Alarm_data = {
            "webHookUrl": "http://192.168.2.217:9000/sendAlarm",
            "token": "123456789qwerty",
            "registerCodes": ["123456789357951239"],
            "allData": 1
        }
        #将传入的参数转换成json格式
        ...
        #请求给智能屏下发基本信息
        self.AlarmData_req = requests.post(headers=self.header, url=self.AlarmData_url, data=self.AlarmData_value)
