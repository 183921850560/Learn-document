...
#将需要用到的常量提取出来 /basePlatform/neighborhoodqueryNbhdDetail
sheet = common.get_xls_sheet("queryNbhdDetail.xls", "queryNbhdDetail")
...
class queryNbhdDetail(unittest.TestCase):
    def setParameters(self, case_name, method, url,id,msg):
...
if __name__ == "__main__":
    ...
    suite.addTest(queryNbhdDetail("testqueryNbhdDetail"))
