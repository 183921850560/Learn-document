...
#将需要用到的常量提取出来
sheet = common.get_xls_sheet("queryNbhdPage.xls", "queryNbhdPage")
...
class queryNbhdPage(unittest.TestCase):
    def setParameters(self, case_name, method, url,pageNum,pageSize, operatorUserId, msg):
        self.case_name = str(case_name)
        self.method = str(method),
        self.url = str(url)
        self.param = [int(pageNum),int(pageSize), int(operatorUserId)]
        self.msg = int(msg)
        self.response = None
        self.info = None
...
if __name__ == "__main__":
    ...
    suite.addTest(queryNbhdPage("testqueryNbhdPage"))
