...
#将变量提取出来
sheet = common.get_xls_sheet("curUserInfo.xls", "curUserInfo")
...
class curUserInfo(unittest.TestCase):
...
if __name__ == "__main__":
    ...
    suite.addTest(curUserInfo("testcurUserInfo"))
